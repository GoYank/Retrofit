...
public class WaterTextView extends android.support.v7.widget.AppCompatTextView {
    ...
    private void init() {
        ...
        Typeface typeface = Typeface.createFromAsset(getResources().getAssets(), "YiShuZi.TTF");
    ...
    private void createShader() {
        Bitmap originalBitmap = BitmapFactory.decodeResource(getResources(), R.mipmap.wave);
